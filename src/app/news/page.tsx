...
const newsItems = [
	{
	  ...
	  description: "Join us at the AI Summit to explore how AI is transforming manufacturing.",
	  imgSrc: "/images/ai_summit.jpeg",
	},
	{
	  title: "Product Launch",
	  description: "We're excited to announce the launch of our latest AI-driven product.",
  ...
  />
	  <section className="py-16">
		...
		<div className="relative w-full h-80 mt-8 overflow-hidden rounded-lg">
		  {newsItems.map((news, index) => (
			...
			>
			  <img src={news.imgSrc} alt={news.title} className="w-full h-full object-cover" />
